	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop', {
		...
		elseif data2.current.value == 'yes' then
				if Config.EnablePlayerManagement then
					...
					end, Config.job, vehicleData.model)
				else
...
AddEventHandler('nb_vehicleshop:hasEnteredMarker', function (zone)
	  ...
	  elseif zone == 'BossActions' and Config.EnablePlayerManagement and ESX.PlayerData.job ~= nil and ESX.PlayerData.job.name == Config.job and ESX.PlayerData.job.grade_name == 'boss' then
